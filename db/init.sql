...
CREATE USER IF NOT EXISTS 'taskmanageruser'@'%' IDENTIFIED BY 'A1b2c3d4';

-- Otorgar todos los permisos sobre la base de datos taskmanager
GRANT ALL PRIVILEGES ON taskmanager.* TO 'taskmanageruser'@'%';
...
('Hector', 'hector@gmail.com', '$2a$10$MGbLn0WEqXgktqQB4tj5I.UzukXnzYbUy5rxkgqSyYKAIeRuapMu2', 1);
